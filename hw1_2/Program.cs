namespace hw1_2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (choice == 1)
            {
                Console.Write($"Enter string (with more than 1 symbol) which you want to transform, please do not use {(char)0} symbol: ");
        ...
        static string BurrowsWheelerTransform(string originalString, out int endIndexOfOriginalInTransformedString)
        {
            ...
            transformedString = transformedString.Replace((char)1, lastSymbol); //change our convenient symbol to original
